...
const letterContent = {
  intro: `Chairing this year's SAFE Gala is an honor of a lifetime and a
  ...
  beautiful work of art, a masterpiece, serving as inspiration for all of us.`,
  
  aboutUs: `To our friends and fellow supporters of SAFE, we are truly grateful for
  ...
  importance: `As Chairs, we understand the importance of SAFE's annual gala and the
  ...
  impact: `These services ensure that survivors receive the help they need, at the
  ...
  closing: `We welcome you to join us at this year's Gallery of Hope gala to
...
export const ChairLetter = () => {
  return (
    ...
    >
      <Box sx={{ maxWidth: '100%', '& p': { whiteSpace: 'normal' } }}>
